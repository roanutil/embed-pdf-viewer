...
const TENANT_ID = 'cloud-named-pages-tenant';
const DOC_ID = 'sample-pdf-named-pages-cloud';

beforeAll(async () => {
  fx = await buildDbSeededFixture({ secret: 'cloud-named-pages-conformance-secret' });
...
runNamedPagesConformance(runner, {
