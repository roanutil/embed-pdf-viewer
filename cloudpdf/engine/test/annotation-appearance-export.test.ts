...
import {
  runAnnotationAppearanceExportConformance,
...
const TENANT_ID = 'cloud-annotation-appearance-export-tenant';
const DOC_ID = 'sample-pdf-annotation-appearance-export-cloud';

beforeAll(async () => {
  fx = await buildDbSeededFixture({
    secret: 'cloud-annotation-appearance-export-conformance-secret',
  });
...
runAnnotationAppearanceExportConformance(runner, {
