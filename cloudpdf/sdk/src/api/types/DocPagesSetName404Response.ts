...
export interface DocPagesSetName404Response {
    name: DocPagesSetName404Response.Name;
    code: DocPagesSetName404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesSetName404Response {
    export const Name = {
