...
export interface DocPagesRemoveName404Response {
    name: DocPagesRemoveName404Response.Name;
    code: DocPagesRemoveName404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesRemoveName404Response {
    export const Name = {
