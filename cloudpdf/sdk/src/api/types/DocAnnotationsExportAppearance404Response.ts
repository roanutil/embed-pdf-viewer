...
export interface DocAnnotationsExportAppearance404Response {
    name: DocAnnotationsExportAppearance404Response.Name;
    code: DocAnnotationsExportAppearance404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsExportAppearance404Response {
    export const Name = {
