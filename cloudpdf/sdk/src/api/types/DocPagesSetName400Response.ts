...
export interface DocPagesSetName400Response {
    name: DocPagesSetName400Response.Name;
    code: DocPagesSetName400Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocPagesSetName400Response {
    export const Name = {
