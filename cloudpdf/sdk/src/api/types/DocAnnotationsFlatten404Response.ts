...
export interface DocAnnotationsFlatten404Response {
    name: DocAnnotationsFlatten404Response.Name;
    code: DocAnnotationsFlatten404Response.Code;
    message: string;
    details?: Record<string, unknown> | undefined;
}

export namespace DocAnnotationsFlatten404Response {
    export const Name = {
