...
const crate = 'poc-geometry';
const artifact = 'poc_geometry';
const outDir = resolve(root, 'packages/geometry/wasm');
...
const cargoToml = readFileSync(resolve(root, 'crates/geometry/Cargo.toml'), 'utf8');
...
cpSync(resolve(root, 'packages/geometry/wasm-types.d.ts'), resolve(outDir, `${artifact}.d.ts`));
